const Tender = () => {
  return (
    <>
      <h1 className="text-center">Tender in Pakistan</h1>
      <h4 className="text-center">State Departments, Provinces, Municipalities and State Companies</h4>
      ...
      <p className="text-danger">واٹس ایپ یا ای میل پر ٹینڈر نوٹس حاصل کرنے کے لیے ابھی سبسکرائب کریں ۔ WhatsApp Now : 03254891919 - 03164484377</p>
      <div className="row">
        <div className="col-8">
          <p>column 8</p>
        </div>
        ...
        <div className="border-bottom border-top mt-3 mb-3 p-3 blinkingEffectOfTenderAlert">
                ...
                </div> <div className=" d-flex justify-content-start flex-column mt-3">
