...
const Header = () => {
  return (
    <div className="container-fluid container-fluid_">
      <div className="row">
        <div className="col-6 tender_logo p-4">
        <img src={tender786Logo} className='logo' alt='logo'/>
        </div>

        
        <div className="col-6 whatsapp_inquirey p-4">

        <div className="d-flex flex-column text-white">
           <span> +9230978967 </span> 
            <span>+9231644843</span>
         </div> 
          <Link to="https://wa.me/+9237584398353" target="_blank" rel="noopener noreferrer" className="btn btn-outline-success text-white rounded-pill" >
      ...
      {/* <div className="row">
        <nav className="nav justify-content-center">
          <Link className="nav-link icons" to="/home">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-house-door-fill" viewBox="0 0 16 16"  style={{ marginRight: '0.1em' , marginBottom : '3px' }}>
          ...
          <Link className="nav-link icons" to="/tender">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-bookmarks" viewBox="0 0 16 16"  style={{ marginRight: '0.1em' , marginBottom : '2px' }}>
          ...
          <Link className="nav-link icons" to="/cities">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-buildings" viewBox="0 0 16 16"  style={{ marginRight: '0.1em' , marginBottom : '2px' }}>
          ...
          <Link className="nav-link icons" to="/categories">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-boxes" viewBox="0 0 16 16"  style={{ marginRight: '0.1em' , marginBottom : '2px' }}>
          ...
          <Link className="nav-link icons" to="/organization">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-diagram-3" viewBox="0 0 16 16"  style={{ marginRight: '0.1em' , marginBottom : '2px' }}>
