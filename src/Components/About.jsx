...
const About = () => {
  return (
    <>
      ...
      <div className='m-4'>
        <Link className="text-decoration-none text-dark icon-link-hover link-underline icon-link" >
      ...
      <div className="container-fluid pl-5  my-5">
        <div className="row ">
          <div className="col-lg-6 mb-4 bgcolor ">
            ...
            <h1>Our Story</h1>
            <p>
              Tender Bismillah comprises of a young, dynamic & experienced team who is passionate about just one thing Helping you in exploring business opportunities by providing right Tenders information & related services Tender Bismillah is your leading edge partner in finding the right tenders. We understand your needs; know the opportunities that exist to fulfil them, and help leverage these opportunities in the shortest possible time. Our team has some of the industry most valued experts who understand the pain points of clients and have put together Tender Bismillah to give you a renewed perspective on Tendering. We have achieved this commendable presence with results across our extensive network.
            </p>
