...
const Footer = () => {
  ...
  <div className="row d-flex justify-content-evenly mb-4">
    ...
    <div className="col-12 col-md-3 text-center text-md-start">
      ...
      <li>
        {/* <img src={mailIcon} alt="Mail Icon" width="21"/>  */}
        <a href="mailto:info@tender786.com" className="footer-link text-white">info@tender786.com</a></li>
        <li className='text-white footer-link'>
          {/* <img src={PhoneLogo} alt="PhoneLogo" width="21" /> */}
