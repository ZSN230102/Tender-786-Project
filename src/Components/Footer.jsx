...
const Footer = () => {
        ...
        <div className="footer-container container-fluid py-1">
            <div className="row align-items-center">
                <div className="col-6 col-md-6 ">
                    <img src={tender786Logo} className="logo" alt="Tender786 Logo" />
                </div>
  ...
  <div className="row d-flex justify-content-evenly mb-4">
    <div className="col-12 col-md-3 text-center text-md-start">
      ...
      <h6 className="mb-3">Your Gateway to Exclusive Tender Opportunities</h6>
      <p>Welcome to Tender 786, your premier source for accessing the latest tender opportunities across a wide range of categories and government departments in Pakistan.</p>
    </div>

    <div className="col-6 col-md-2 text-center text-md-start">
      <p className="mb-2 customColor">Our Services</p>
      <ul className="list-unstyled footer-list">
        <li><a href="#organization" className="footer-link">Organization</a></li>
        <li><a href="#category" className="footer-link">Category</a></li>
        <li><a href="#tender" className="footer-link">Tender</a></li>
        <li><a href="#cities" className="footer-link">Cities</a></li>
      </ul>
    </div>
    ...
    <div className="col-6 col-md-2 text-center text-md-start">
      ...
      <ul className="list-unstyled footer-list">
        ...
        <li><a href="#latest-tender" className="footer-link">Get's Latest Tender</a></li>
        <li><a href="#privacy-policy" className="footer-link"><strong>Privacy Policy</strong></a></li>
      </ul>
    </div>
    ...
    <div className="col-12 col-md-3 text-center text-md-start">
      ...
      <ul className="list-unstyled">
        <li><a href="mailto:info@tender786.com" className="footer-link">info@tender786.com</a></li>
        <li>0325 4891919 - 0316 4484377</li>
        <li><strong>We are not responsible for any missing tender due to any reason</strong></li>
      </ul>
    </div>
  </div>
  <hr />
  <div className="row text-center">
    <div className="col-12">
      <p className="fw-bold mb-3">Copyright &copy; 2024 Tender786 Ltd. All Rights Reserved.</p>
    </div>
  </div>
</div>
