...
export default function TenderByOrgnization() {
  return (
    <div>
        <h2 className='text-center fw-bolder'>
        Tender By Orgnization
        </h2>
        ...
        <div className="row d-flex justify-content-center align-items-center gap-3 tenderByRows">
            ...
            <div className="text-center">
                <Link className="btn theme-color btn-outline-success rounded-pill text-decoration-none text-white">View Orgnization</Link>
            </div>
        </div>
        </div>
    </div>
